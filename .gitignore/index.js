...
client.on('message', async message => { 
    ...
    if(message.content === "Té qui toi"){
        message.reply("Je suis un :robot:robot:robot:.... **Creer Par Horizon**....Tu veux étre Mon ami ?");
    ...
    if(message.content === prefix + "desc") {
      ...
      .addField("Salut ! je suis le :robot: Creer Par Horizon le 2/10/2018 et la alpha 1 est fini le 11/11/2018 !")
      .setThumbnail(message.author.avatarURL)
      .setTimestamp()
